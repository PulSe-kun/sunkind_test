    ...
    <div class="footer">
      ...
      >
        ...
        <div class="dialog-content">
          ...
          <a-form-model-item label="故障描述" prop="faultWhy">
            <a-textarea
              size="large"
          ...
          <a-form-model-item label="维修人" prop="userId">
            <a-select
              show-search
              option-filter-prop="children"
              size="large"
...
<script>
import { addRepairBill, uploadImages } from "@/services/api";
