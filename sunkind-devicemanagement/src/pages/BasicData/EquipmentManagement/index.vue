<template>
  <div class="EquipmentManagement">
    ...
    <div class="EquipmentManagement-content">
      <div class="header">
        <div>
          <ul>
            <li>
      ...
      <div class="EquipmentManagement-table">
        <div class="table-btn">
    ...
    <template>
      ...
      <EditorDialog
        ...
        @refresh="refresh"
      />
      <DetailsDialog ref="detailsDialog" :item="dataObj" />
...
import { getDeviceTree, getDeviceData, getDeviceTable } from "@/services/api";
...
<style lang="less" scoped>
.EquipmentManagement .EquipmentManagement-content {
  overflow: auto;
}
</style>