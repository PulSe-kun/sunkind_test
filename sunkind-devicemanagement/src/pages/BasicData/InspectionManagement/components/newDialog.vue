    ...
    <div class="footer">
      ...
      >
        ...
        <div class="dialog-content">
          ...
          <a-form-model-item label="点检项名称" prop="name">
            <a-input
              size="large"
              v-model="form.name"
          ...
          <a-form-model-item label="点检内容" prop="content">
            <a-textarea
              size="large"
          ...
          <a-form-model-item label="判定标准" prop="criteria">
            <a-textarea
              size="large"
...
<script>
import { uploadImages, addInspection } from "@/services/api";
