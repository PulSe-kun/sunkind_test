<template>
  <div class="MaintenanceManagement">
    ...
    <div class="MaintenanceManagement-content">
      <div class="header">
        <div>
          <ul>
            <li>
      ...
      <div class="MaintenanceManagement-table">
        <div class="table-btn">
  ...
  methods: {
    ...
    setNode(data, parentId) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        if (data[i].byxAmount !== 0) {
          data[i].names = data[i].name + "( " + data[i].byxAmount + " )";
        }
    ...
    getMaintainSelectData() {
      ...
      this.spinning = true;
      getMaintainSelect(params).then((res) => {
        console.log(res);
        this.spinning = false;
        if (res.status === 200) {
...
<style lang="less" scoped>
.MaintenanceManagement .MaintenanceManagement-content {
  overflow: auto;
}
