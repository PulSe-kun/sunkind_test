<template>
  <div class="MaintenanceBills">
    ...
    <div class="MaintenanceBills-table">
...
import { getUsers_xj, getMaintainBillTable } from "@/services/api";
...
export default {
  ...
  methods: {
    ...
    getMaintainBillTableData() {
      ...
      this.spinning = true;
      getMaintainBillTable(params).then((res) => {
        console.log(res);
        this.spinning = false;
        if (res.status === 200) {
