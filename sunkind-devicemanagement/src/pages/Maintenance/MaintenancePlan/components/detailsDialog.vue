  ...
  <a-drawer :closable="false" placement="right" :zIndex="999" width="620" :visible="visible" wrapClassName="dialog-right" :mask="false">
    <div class="header">
      <div class="header-title">
        <span v-if="item">{{ item.cmName + " " + item.cmNum + " " + item.deptName }}</span>
      ...
      <div class="dialog-content">
        <div>
          <a-descriptions :column="1">
            <a-descriptions-item label="保养周期">
            ...
            <a-descriptions-item label="保养人">
              <span>{{ item.userName | emptyValue }}</span>
            </a-descriptions-item>
            <a-descriptions-item label="计划描述">
              <span>{{ item.description | emptyValue }}</span>
            </a-descriptions-item>
