    ...
    <a-tabs :default-active-key="activeKey" @change="callback">
      <a-tab-pane key="0">
        ...
        <div class="tab-content">
          ...
          <div class="MaintenanceTask-table">
                ...
                >
                  ...
                  <template slot="action" slot-scope="text, item">
                    ...
                    >
                      <a
                        class="link-style primary-a"
                        @click="editor('保养', item)"
                        >保养</a
                      >
                      <a
                        class="link-style primary-a"
                        @click="editor('无需保养', item)"
                        >无需保养</a
                      >
                      <a
                        class="link-style primary-a"
...
export default {
  ...
  methods: {
    ...
    getRemainingTableData() {
      ...
      this.spinning = true;
      getRemainingTable(params).then((res) => {
        this.spinning = false;
        console.log(res);
        if (res.status === 200) {
          ...
          for (let i = 0; i < rows.length; i++) {
            ...
            if (rows[i].cmItems && rows[i].cmItems.length > 0) {
              rows[i].cmItems.map((cmItem, index) => {
                if (index == rows[i].cmItems.length - 1) {
                  rows[i].maintenanceItem += cmItem.name;
                } else {
                  rows[i].maintenanceItem += cmItem.name + " 、 ";
                }
              });
    ...
    getFinishedTableData() {
      ...
      getFinishedTable(params).then((res) => {
