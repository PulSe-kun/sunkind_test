<template>
  <div class="InspectionPlan">
    ...
    <div class="InspectionPlan-content">
      <div class="header">
        <div>
          <ul>
            <li>
      ...
      <div class="InspectionPlan-table">
        <div class="table-btn">
  ...
  methods: {
    ...
    setNode(data, parentId) {
      ...
      for (var i = 0; i < data.length; i++) {
        num = i;
        // console.log(data[i]);
        if (data[i].djAmount !== 0) {
          data[i].name = data[i].name + "( " + data[i].djAmount + " )";
        }
    ...
    async getDeviceTreeData() {
      await getDeviceTree().then((res) => {
        ...
        this.getInspectionPlanTableData();
      });
    },
    /**
     *
    ...
    getInspectionPlanTableData() {
      ...
      this.spinning = true;
      getInspectionPlanTable(params).then((res) => {
        console.log(res);
        this.spinning = false;
        if (res.status === 200) {
...
<style lang="less" scoped>
.InspectionPlan .InspectionPlan-content {
  overflow: auto;
}
