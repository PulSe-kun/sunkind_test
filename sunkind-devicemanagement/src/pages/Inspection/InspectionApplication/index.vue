<template>
  <div class="InspectionApplication">
      ...
      <div>
        <ul>
          ...
          <li>
            ...
            >
              <a-select-option
                v-for="item in $state.inspectionStatus"
                :key="item.id"
                :value="item.id"
              >
                {{ item.value }}
    ...
    <div class="InspectionApplication-table">
      <div class="table-btn">
        <a-button
          class="primary-style"
          type="primary"
          ...
          if (res.data.rows && res.data.rows.length > 0) {
            res.data.rows.map((item) => {
              ...
              if (item.cmCheckouts && item.cmCheckouts.length > 0) {
                item.cmCheckouts.map((cmItem, index) => {
